...
<head>
    ...
    <title>{{ config('app.name', 'Yahaal App') }}</title>

    <link rel='stylesheet' href='{{ URL::asset('assets/css/style.css') }}' type='text/css' />
    <link rel='stylesheet' href='{{ URL::asset('assets/css/jquery.mmenu.css') }}' type='text/css' />
...
<body  onload="runSpinner()" class="archive post-type-archive post-type-archive-gd_place geodir_custom_posts geodir-page geodir-archive geodir_advance_search gd-map-auto">
